...
import 'field_mask.pb.dart' as $4;
import 'source_context.pb.dart' as $5;
...
class TestWellKnownTypes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestWellKnownTypes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..aOM<$1.Api>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiField', subBuilder: $1.Api.create)
    ..aOM<$2.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'durationField', subBuilder: $2.Duration.create)
    ..aOM<$3.Empty>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emptyField', subBuilder: $3.Empty.create)
    ..aOM<$4.FieldMask>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldMaskField', subBuilder: $4.FieldMask.create)
    ..aOM<$5.SourceContext>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContextField', subBuilder: $5.SourceContext.create)
    ..aOM<$6.Struct>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structField', subBuilder: $6.Struct.create)
    ..aOM<$7.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampField', subBuilder: $7.Timestamp.create)
    ..aOM<$8.Type>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeField', subBuilder: $8.Type.create)
    ...
    ..aOM<$6.Value>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueField', subBuilder: $6.Value.create)
  ...
  @$pb.TagNumber(2)
  $1.Api get apiField => $_getN(1);
  @$pb.TagNumber(2)
  set apiField($1.Api v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasApiField() => $_has(1);
  @$pb.TagNumber(2)
  void clearApiField() => clearField(2);
  @$pb.TagNumber(2)
  $1.Api ensureApiField() => $_ensure(1);

  @$pb.TagNumber(3)
  $2.Duration get durationField => $_getN(2);
  @$pb.TagNumber(3)
  set durationField($2.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDurationField() => $_has(2);
  @$pb.TagNumber(3)
  void clearDurationField() => clearField(3);
  @$pb.TagNumber(3)
  $2.Duration ensureDurationField() => $_ensure(2);

  @$pb.TagNumber(4)
  $3.Empty get emptyField => $_getN(3);
  @$pb.TagNumber(4)
  set emptyField($3.Empty v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEmptyField() => $_has(3);
  @$pb.TagNumber(4)
  void clearEmptyField() => clearField(4);
  @$pb.TagNumber(4)
  $3.Empty ensureEmptyField() => $_ensure(3);

  @$pb.TagNumber(5)
  $4.FieldMask get fieldMaskField => $_getN(4);
  @$pb.TagNumber(5)
  set fieldMaskField($4.FieldMask v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFieldMaskField() => $_has(4);
  @$pb.TagNumber(5)
  void clearFieldMaskField() => clearField(5);
  @$pb.TagNumber(5)
  $4.FieldMask ensureFieldMaskField() => $_ensure(4);

  @$pb.TagNumber(6)
  $5.SourceContext get sourceContextField => $_getN(5);
  @$pb.TagNumber(6)
  set sourceContextField($5.SourceContext v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasSourceContextField() => $_has(5);
  @$pb.TagNumber(6)
  void clearSourceContextField() => clearField(6);
  @$pb.TagNumber(6)
  $5.SourceContext ensureSourceContextField() => $_ensure(5);

  @$pb.TagNumber(7)
  $6.Struct get structField => $_getN(6);
  @$pb.TagNumber(7)
  set structField($6.Struct v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasStructField() => $_has(6);
  @$pb.TagNumber(7)
  void clearStructField() => clearField(7);
  @$pb.TagNumber(7)
  $6.Struct ensureStructField() => $_ensure(6);
  ...
  @$pb.TagNumber(8)
  $7.Timestamp ensureTimestampField() => $_ensure(7);

  @$pb.TagNumber(9)
  $8.Type get typeField => $_getN(8);
  @$pb.TagNumber(9)
  set typeField($8.Type v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTypeField() => $_has(8);
  @$pb.TagNumber(9)
  void clearTypeField() => clearField(9);
  @$pb.TagNumber(9)
  $8.Type ensureTypeField() => $_ensure(8);
  ...
  @$pb.TagNumber(19)
  $6.Value get valueField => $_getN(18);
  @$pb.TagNumber(19)
  set valueField($6.Value v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasValueField() => $_has(18);
  @$pb.TagNumber(19)
  void clearValueField() => clearField(19);
  @$pb.TagNumber(19)
  $6.Value ensureValueField() => $_ensure(18);
}
...
class RepeatedWellKnownTypes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RepeatedWellKnownTypes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..pc<$1.Api>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiField', $pb.PbFieldType.PM, subBuilder: $1.Api.create)
    ..pc<$2.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'durationField', $pb.PbFieldType.PM, subBuilder: $2.Duration.create)
    ..pc<$3.Empty>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emptyField', $pb.PbFieldType.PM, subBuilder: $3.Empty.create)
    ..pc<$4.FieldMask>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldMaskField', $pb.PbFieldType.PM, subBuilder: $4.FieldMask.create)
    ..pc<$5.SourceContext>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContextField', $pb.PbFieldType.PM, subBuilder: $5.SourceContext.create)
    ..pc<$6.Struct>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structField', $pb.PbFieldType.PM, subBuilder: $6.Struct.create)
    ..pc<$7.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampField', $pb.PbFieldType.PM, subBuilder: $7.Timestamp.create)
    ..pc<$8.Type>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeField', $pb.PbFieldType.PM, subBuilder: $8.Type.create)
  ...
  factory RepeatedWellKnownTypes({
    ...
    $core.Iterable<$1.Api>? apiField,
    $core.Iterable<$2.Duration>? durationField,
    $core.Iterable<$3.Empty>? emptyField,
    $core.Iterable<$4.FieldMask>? fieldMaskField,
    $core.Iterable<$5.SourceContext>? sourceContextField,
    $core.Iterable<$6.Struct>? structField,
    $core.Iterable<$7.Timestamp>? timestampField,
    $core.Iterable<$8.Type>? typeField,
  ...
  @$pb.TagNumber(2)
  $core.List<$1.Api> get apiField => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$2.Duration> get durationField => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$3.Empty> get emptyField => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<$4.FieldMask> get fieldMaskField => $_getList(4);

  @$pb.TagNumber(6)
  $core.List<$5.SourceContext> get sourceContextField => $_getList(5);

  @$pb.TagNumber(7)
  $core.List<$6.Struct> get structField => $_getList(6);

  @$pb.TagNumber(8)
  $core.List<$7.Timestamp> get timestampField => $_getList(7);

  @$pb.TagNumber(9)
  $core.List<$8.Type> get typeField => $_getList(8);
...
class MapWellKnownTypes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MapWellKnownTypes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..m<$core.int, $1.Api>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiField', entryClassName: 'MapWellKnownTypes.ApiFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Api.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $2.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'durationField', entryClassName: 'MapWellKnownTypes.DurationFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.Duration.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $3.Empty>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emptyField', entryClassName: 'MapWellKnownTypes.EmptyFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $3.Empty.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $4.FieldMask>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldMaskField', entryClassName: 'MapWellKnownTypes.FieldMaskFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4.FieldMask.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $5.SourceContext>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContextField', entryClassName: 'MapWellKnownTypes.SourceContextFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $5.SourceContext.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $6.Struct>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structField', entryClassName: 'MapWellKnownTypes.StructFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $6.Struct.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $7.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampField', entryClassName: 'MapWellKnownTypes.TimestampFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $7.Timestamp.create, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $8.Type>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeField', entryClassName: 'MapWellKnownTypes.TypeFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $8.Type.create, packageName: const $pb.PackageName('protobuf_unittest'))
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.int, $1.Api> get apiField => $_getMap(1);

  @$pb.TagNumber(3)
  $core.Map<$core.int, $2.Duration> get durationField => $_getMap(2);

  @$pb.TagNumber(4)
  $core.Map<$core.int, $3.Empty> get emptyField => $_getMap(3);

  @$pb.TagNumber(5)
  $core.Map<$core.int, $4.FieldMask> get fieldMaskField => $_getMap(4);

  @$pb.TagNumber(6)
  $core.Map<$core.int, $5.SourceContext> get sourceContextField => $_getMap(5);

  @$pb.TagNumber(7)
  $core.Map<$core.int, $6.Struct> get structField => $_getMap(6);

  @$pb.TagNumber(8)
  $core.Map<$core.int, $7.Timestamp> get timestampField => $_getMap(7);

  @$pb.TagNumber(9)
  $core.Map<$core.int, $8.Type> get typeField => $_getMap(8);
